...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a token-level hallucination classifier.")
    parser.add_argument("--features", required=True, help="Token feature CSV, JSONL, or Parquet file.")
...
def main() -> None:
    ...
    validate_feature_frame(frame, "token")
    ...
    validate_training_frame(train_frame, args.label_col, "token classifier")
